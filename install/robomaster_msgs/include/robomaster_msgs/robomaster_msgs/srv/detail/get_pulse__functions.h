...
#ifndef ROBOMASTER_MSGS__SRV__DETAIL__GET_PULSE__FUNCTIONS_H_
#define ROBOMASTER_MSGS__SRV__DETAIL__GET_PULSE__FUNCTIONS_H_
...
/// Initialize srv/GetPulse message.
/**
...
/// Create srv/GetPulse message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robomaster_msgs__srv__GetPulse_Request__init().
...
/// Destroy srv/GetPulse message.
/**
 * It calls
 * robomaster_msgs__srv__GetPulse_Request__fini()
...
/// Check for srv/GetPulse message equality.
/**
...
/// Initialize array of srv/GetPulse messages.
/**
...
/// Finalize array of srv/GetPulse messages.
/**
 * It calls
 * robomaster_msgs__srv__GetPulse_Request__fini()
...
/// Create array of srv/GetPulse messages.
/**
 * It allocates the memory for the array and calls
 * robomaster_msgs__srv__GetPulse_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetPulse messages.
/**
 * It calls
 * robomaster_msgs__srv__GetPulse_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetPulse message array equality.
/**
...
/// Copy an array of srv/GetPulse messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robomaster_msgs__srv__GetPulse_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robomaster_msgs
...
/**
 * It calls
 * robomaster_msgs__srv__GetPulse_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robomaster_msgs
...
/**
 * It allocates the memory for the array and calls
 * robomaster_msgs__srv__GetPulse_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robomaster_msgs
...
/**
 * It calls
 * robomaster_msgs__srv__GetPulse_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOMASTER_MSGS__SRV__DETAIL__GET_PULSE__FUNCTIONS_H_
