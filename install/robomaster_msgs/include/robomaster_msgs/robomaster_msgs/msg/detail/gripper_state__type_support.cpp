...
{
  new (message_memory) robomaster_msgs::msg::GripperState(_init);
}

void GripperState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robomaster_msgs::msg::GripperState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperState_message_member_array[2] = {
  {
    ...
    offsetof(robomaster_msgs::msg::GripperState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomaster_msgs::msg::GripperState, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperState_message_members = {
  ...
  2,  // number of fields
  sizeof(robomaster_msgs::msg::GripperState),
...
{
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robomaster_msgs, msg, GripperState)() {
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
