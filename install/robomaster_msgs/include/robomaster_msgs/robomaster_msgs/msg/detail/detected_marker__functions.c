...
robomaster_msgs__msg__DetectedMarker__init(robomaster_msgs__msg__DetectedMarker * msg)
{
  ...
  if (!robomaster_msgs__msg__RegionOfInterest__init(&msg->roi)) {
    robomaster_msgs__msg__DetectedMarker__fini(msg);
    return false;
  }
  // kind
...
robomaster_msgs__msg__DetectedMarker__create()
{
  ...
  robomaster_msgs__msg__DetectedMarker * msg = (robomaster_msgs__msg__DetectedMarker *)allocator.allocate(sizeof(robomaster_msgs__msg__DetectedMarker), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robomaster_msgs__msg__DetectedMarker));
  bool success = robomaster_msgs__msg__DetectedMarker__init(msg);
  if (!success) {
...
robomaster_msgs__msg__DetectedMarker__Sequence__init(robomaster_msgs__msg__DetectedMarker__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__DetectedMarker * data = NULL;

  if (size) {
    data = (robomaster_msgs__msg__DetectedMarker *)allocator.zero_allocate(size, sizeof(robomaster_msgs__msg__DetectedMarker), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robomaster_msgs__msg__DetectedMarker__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robomaster_msgs__msg__DetectedMarker__fini(&data[i - 1]);
      }
...
robomaster_msgs__msg__DetectedMarker__Sequence__fini(robomaster_msgs__msg__DetectedMarker__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robomaster_msgs__msg__DetectedMarker__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__DetectedMarker__Sequence * array = (robomaster_msgs__msg__DetectedMarker__Sequence *)allocator.allocate(sizeof(robomaster_msgs__msg__DetectedMarker__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robomaster_msgs__msg__DetectedMarker__Sequence__init(array, size);
  if (!success) {
...
robomaster_msgs__msg__DetectedMarker__Sequence__destroy(robomaster_msgs__msg__DetectedMarker__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robomaster_msgs__msg__DetectedMarker__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robomaster_msgs__msg__DetectedMarker__Sequence__are_equal(const robomaster_msgs__msg__DetectedMarker__Sequence * lhs, const robomaster_msgs__msg__DetectedMarker__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robomaster_msgs__msg__DetectedMarker__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robomaster_msgs__msg__DetectedMarker__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robomaster_msgs__msg__DetectedMarker);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robomaster_msgs__msg__DetectedMarker * data =
      (robomaster_msgs__msg__DetectedMarker *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robomaster_msgs__msg__DetectedMarker__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robomaster_msgs__msg__DetectedMarker__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robomaster_msgs__msg__DetectedMarker__copy(
