...
#ifndef ROBOMASTER_MSGS__MSG__DETAIL__CAMERA_CONFIG__FUNCTIONS_H_
#define ROBOMASTER_MSGS__MSG__DETAIL__CAMERA_CONFIG__FUNCTIONS_H_
 ...
 * calls
 * robomaster_msgs__msg__CameraConfig__init().
...
/**
 * It calls
 * robomaster_msgs__msg__CameraConfig__fini()
 ...
 * robomaster_msgs__msg__CameraConfig__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robomaster_msgs__msg__CameraConfig__Sequence__fini()
 * on the array,
...
#endif  // ROBOMASTER_MSGS__MSG__DETAIL__CAMERA_CONFIG__FUNCTIONS_H_
