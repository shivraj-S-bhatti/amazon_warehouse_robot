...
#ifndef ROBOMASTER_MSGS__MSG__DETAIL__DETECTED_PERSON__TRAITS_HPP_
#define ROBOMASTER_MSGS__MSG__DETAIL__DETECTED_PERSON__TRAITS_HPP_
...
inline void to_yaml(
  const robomaster_msgs::msg::DetectedPerson & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const robomaster_msgs::msg::DetectedPerson & msg)
{
  return robomaster_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<robomaster_msgs::msg::DetectedPerson>()
{
  return "robomaster_msgs::msg::DetectedPerson";
}

template<>
inline const char * name<robomaster_msgs::msg::DetectedPerson>()
{
  return "robomaster_msgs/msg/DetectedPerson";
}

template<>
struct has_fixed_size<robomaster_msgs::msg::DetectedPerson>
  : std::integral_constant<bool, has_fixed_size<robomaster_msgs::msg::RegionOfInterest>::value> {};

template<>
struct has_bounded_size<robomaster_msgs::msg::DetectedPerson>
  : std::integral_constant<bool, has_bounded_size<robomaster_msgs::msg::RegionOfInterest>::value> {};

template<>
struct is_message<robomaster_msgs::msg::DetectedPerson>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOMASTER_MSGS__MSG__DETAIL__DETECTED_PERSON__TRAITS_HPP_
