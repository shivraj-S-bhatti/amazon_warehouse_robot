...
class Metaclass_Move_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_Goal')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'LINEAR_SPEED__DEFAULT': 0.5,
            'ANGULAR_SPEED__DEFAULT': 0.5236,
        }

    @property
    def LINEAR_SPEED__DEFAULT(cls):
        """Return default value for message field 'linear_speed'."""
        return 0.5

    @property
    def ANGULAR_SPEED__DEFAULT(cls):
        """Return default value for message field 'angular_speed'."""
        return 0.5236
...
class Move_Goal(metaclass=Metaclass_Move_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.linear_speed = kwargs.get(
            'linear_speed', Move_Goal.LINEAR_SPEED__DEFAULT)
        self.angular_speed = kwargs.get(
            'angular_speed', Move_Goal.ANGULAR_SPEED__DEFAULT)
...
class Metaclass_Move_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robomaster_msgs/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robomaster_msgs.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from robomaster_msgs.action._move import Move_SendGoal_Request as Request
    from robomaster_msgs.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robomaster_msgs/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from robomaster_msgs.action._move import Move_GetResult_Request as Request
    from robomaster_msgs.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robomaster_msgs/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robomaster_msgs.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from robomaster_msgs.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from robomaster_msgs.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from robomaster_msgs.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robomaster_msgs.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robomaster_msgs.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robomaster_msgs.action._move import Move_FeedbackMessage as FeedbackMessage
