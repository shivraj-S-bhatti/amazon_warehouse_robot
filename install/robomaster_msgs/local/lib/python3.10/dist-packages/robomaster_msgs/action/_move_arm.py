    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_Goal')
            logger.debug(
...
class Metaclass_MoveArm_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveArm_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_SendGoal_Request(metaclass=Metaclass_MoveArm_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robomaster_msgs/MoveArm_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveArm_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move_arm import MoveArm_Goal
...
class Metaclass_MoveArm_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robomaster_msgs.action import _move_arm
...
class MoveArm_SendGoal(metaclass=Metaclass_MoveArm_SendGoal):
    from robomaster_msgs.action._move_arm import MoveArm_SendGoal_Request as Request
    from robomaster_msgs.action._move_arm import MoveArm_SendGoal_Response as Response
...
class MoveArm_GetResult_Response(metaclass=Metaclass_MoveArm_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robomaster_msgs/MoveArm_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveArm_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move_arm import MoveArm_Result
...
class Metaclass_MoveArm_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_GetResult(metaclass=Metaclass_MoveArm_GetResult):
    from robomaster_msgs.action._move_arm import MoveArm_GetResult_Request as Request
    from robomaster_msgs.action._move_arm import MoveArm_GetResult_Response as Response
...
class Metaclass_MoveArm_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_FeedbackMessage(metaclass=Metaclass_MoveArm_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robomaster_msgs/MoveArm_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveArm_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robomaster_msgs.action._move_arm import MoveArm_Feedback
...
class Metaclass_MoveArm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveArm')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm(metaclass=Metaclass_MoveArm):
    ...
    from robomaster_msgs.action._move_arm import MoveArm_Goal as Goal
    # The result message defined in the action definition.
    from robomaster_msgs.action._move_arm import MoveArm_Result as Result
    # The feedback message defined in the action definition.
    from robomaster_msgs.action._move_arm import MoveArm_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robomaster_msgs.action._move_arm import MoveArm_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robomaster_msgs.action._move_arm import MoveArm_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robomaster_msgs.action._move_arm import MoveArm_FeedbackMessage as FeedbackMessage
