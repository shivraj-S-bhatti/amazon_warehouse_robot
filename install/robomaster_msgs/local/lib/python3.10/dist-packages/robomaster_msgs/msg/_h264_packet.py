...
class Metaclass_H264Packet(type):
    """Metaclass of message 'H264Packet'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__h264_packet
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__h264_packet
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__h264_packet
            cls._TYPE_SUPPORT = module.type_support_msg__msg__h264_packet
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__h264_packet
...
class H264Packet(metaclass=Metaclass_H264Packet):
    """Message class 'H264Packet'."""
