...
bool robomaster_msgs__msg__wheel_speeds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomaster_msgs.msg._wheel_speeds.WheelSpeeds", full_classname_dest, 45) == 0);
  }
  robomaster_msgs__msg__WheelSpeeds * ros_message = _ros_message;
  {  // front_left
...
PyObject * robomaster_msgs__msg__wheel_speeds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomaster_msgs.msg._wheel_speeds");
