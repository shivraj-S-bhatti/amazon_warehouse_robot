...
bool robomaster_msgs__msg__detected_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomaster_msgs.msg._detected_line.DetectedLine", full_classname_dest, 47) == 0);
  }
  robomaster_msgs__msg__DetectedLine * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of DetectedLine */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomaster_msgs.msg._detected_line");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectedLine");
