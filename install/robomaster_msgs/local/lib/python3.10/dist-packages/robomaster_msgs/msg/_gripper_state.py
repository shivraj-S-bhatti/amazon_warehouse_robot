...
class Metaclass_GripperState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robomaster_msgs.msg.GripperState')
            logger.debug(
    ...
    def PAUSE(self):
        ...
        return Metaclass_GripperState.__constants['PAUSE']

    @property
    def OPEN(self):
        """Message constant 'OPEN'."""
        return Metaclass_GripperState.__constants['OPEN']

    @property
    def CLOSE(self):
        """Message constant 'CLOSE'."""
        return Metaclass_GripperState.__constants['CLOSE']
