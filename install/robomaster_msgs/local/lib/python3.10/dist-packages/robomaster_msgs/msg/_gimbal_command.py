...
class Metaclass_GimbalCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robomaster_msgs.msg.GimbalCommand')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'YAW_SPEED__DEFAULT': 0.0,
            'PITCH_SPEED__DEFAULT': 0.0,
        }
...
class GimbalCommand(metaclass=Metaclass_GimbalCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.yaw_speed = kwargs.get(
            'yaw_speed', GimbalCommand.YAW_SPEED__DEFAULT)
        self.pitch_speed = kwargs.get(
            'pitch_speed', GimbalCommand.PITCH_SPEED__DEFAULT)
