...
robomaster_msgs__msg__SBus__init(robomaster_msgs__msg__SBus * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    robomaster_msgs__msg__SBus__fini(msg);
    return false;
  }
  // channels
  return true;
...
robomaster_msgs__msg__SBus__create()
{
  ...
  robomaster_msgs__msg__SBus * msg = (robomaster_msgs__msg__SBus *)allocator.allocate(sizeof(robomaster_msgs__msg__SBus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robomaster_msgs__msg__SBus));
  bool success = robomaster_msgs__msg__SBus__init(msg);
  if (!success) {
...
robomaster_msgs__msg__SBus__Sequence__init(robomaster_msgs__msg__SBus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__SBus * data = NULL;

  if (size) {
    data = (robomaster_msgs__msg__SBus *)allocator.zero_allocate(size, sizeof(robomaster_msgs__msg__SBus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robomaster_msgs__msg__SBus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robomaster_msgs__msg__SBus__fini(&data[i - 1]);
      }
...
robomaster_msgs__msg__SBus__Sequence__fini(robomaster_msgs__msg__SBus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robomaster_msgs__msg__SBus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__SBus__Sequence * array = (robomaster_msgs__msg__SBus__Sequence *)allocator.allocate(sizeof(robomaster_msgs__msg__SBus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robomaster_msgs__msg__SBus__Sequence__init(array, size);
  if (!success) {
...
robomaster_msgs__msg__SBus__Sequence__destroy(robomaster_msgs__msg__SBus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robomaster_msgs__msg__SBus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robomaster_msgs__msg__SBus__Sequence__are_equal(const robomaster_msgs__msg__SBus__Sequence * lhs, const robomaster_msgs__msg__SBus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robomaster_msgs__msg__SBus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robomaster_msgs__msg__SBus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robomaster_msgs__msg__SBus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robomaster_msgs__msg__SBus * data =
      (robomaster_msgs__msg__SBus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robomaster_msgs__msg__SBus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robomaster_msgs__msg__SBus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robomaster_msgs__msg__SBus__copy(
