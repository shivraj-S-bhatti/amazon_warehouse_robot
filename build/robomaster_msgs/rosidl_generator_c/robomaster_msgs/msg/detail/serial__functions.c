...
robomaster_msgs__msg__Serial__init(robomaster_msgs__msg__Serial * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    robomaster_msgs__msg__Serial__fini(msg);
    return false;
  }
  // data
...
robomaster_msgs__msg__Serial__create()
{
  ...
  robomaster_msgs__msg__Serial * msg = (robomaster_msgs__msg__Serial *)allocator.allocate(sizeof(robomaster_msgs__msg__Serial), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robomaster_msgs__msg__Serial));
  bool success = robomaster_msgs__msg__Serial__init(msg);
  if (!success) {
...
robomaster_msgs__msg__Serial__Sequence__init(robomaster_msgs__msg__Serial__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__Serial * data = NULL;

  if (size) {
    data = (robomaster_msgs__msg__Serial *)allocator.zero_allocate(size, sizeof(robomaster_msgs__msg__Serial), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robomaster_msgs__msg__Serial__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robomaster_msgs__msg__Serial__fini(&data[i - 1]);
      }
...
robomaster_msgs__msg__Serial__Sequence__fini(robomaster_msgs__msg__Serial__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robomaster_msgs__msg__Serial__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robomaster_msgs__msg__Serial__Sequence * array = (robomaster_msgs__msg__Serial__Sequence *)allocator.allocate(sizeof(robomaster_msgs__msg__Serial__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robomaster_msgs__msg__Serial__Sequence__init(array, size);
  if (!success) {
...
robomaster_msgs__msg__Serial__Sequence__destroy(robomaster_msgs__msg__Serial__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robomaster_msgs__msg__Serial__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robomaster_msgs__msg__Serial__Sequence__are_equal(const robomaster_msgs__msg__Serial__Sequence * lhs, const robomaster_msgs__msg__Serial__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robomaster_msgs__msg__Serial__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robomaster_msgs__msg__Serial__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robomaster_msgs__msg__Serial);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robomaster_msgs__msg__Serial * data =
      (robomaster_msgs__msg__Serial *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robomaster_msgs__msg__Serial__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robomaster_msgs__msg__Serial__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robomaster_msgs__msg__Serial__copy(
