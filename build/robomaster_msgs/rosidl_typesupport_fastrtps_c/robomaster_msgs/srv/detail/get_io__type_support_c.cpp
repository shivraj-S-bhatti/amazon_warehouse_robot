...
#include "robomaster_msgs/srv/detail/get_io__rosidl_typesupport_fastrtps_c.h"
...
using _GetIO_Request__ros_msg_type = robomaster_msgs__srv__GetIO_Request;
...
size_t get_serialized_size_robomaster_msgs__srv__GetIO_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetIO_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__srv__GetIO_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomaster_msgs
size_t max_serialized_size_robomaster_msgs__srv__GetIO_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__srv__GetIO_Request;
    is_plain =
      (
...
static size_t _GetIO_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__srv__GetIO_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetIO_Request)() {
...
using _GetIO_Response__ros_msg_type = robomaster_msgs__srv__GetIO_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomaster_msgs
size_t get_serialized_size_robomaster_msgs__srv__GetIO_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetIO_Response__ros_msg_type * ros_message = static_cast<const _GetIO_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__srv__GetIO_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomaster_msgs
size_t max_serialized_size_robomaster_msgs__srv__GetIO_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robomaster_msgs__srv__GetIO_Response;
    is_plain =
      (
...
static size_t _GetIO_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__srv__GetIO_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetIO_Response)() {
...
// already included above
// #include "robomaster_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robomaster_msgs/srv/get_io.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetIO)() {
