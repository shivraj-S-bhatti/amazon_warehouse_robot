...
#include "robomaster_msgs/msg/detail/pwm__rosidl_typesupport_fastrtps_c.h"
...
using _PWM__ros_msg_type = robomaster_msgs__msg__PWM;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fraction_of_duty_cycle
  {
    size_t size = 6;
    auto array_ptr = ros_message->fraction_of_duty_cycle;
...
size_t get_serialized_size_robomaster_msgs__msg__PWM(
  const void * untyped_ros_message,
...
static uint32_t _PWM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__msg__PWM(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomaster_msgs
size_t max_serialized_size_robomaster_msgs__msg__PWM(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__msg__PWM;
    is_plain =
      (
...
static size_t _PWM__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__msg__PWM(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, msg, PWM)() {
