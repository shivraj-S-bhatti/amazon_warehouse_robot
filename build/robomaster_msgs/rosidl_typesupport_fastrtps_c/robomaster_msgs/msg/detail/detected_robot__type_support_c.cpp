...
#include "robomaster_msgs/msg/detail/detected_robot__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedRobot__ros_msg_type = robomaster_msgs__msg__DetectedRobot;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DetectedRobot__ros_msg_type * ros_message = static_cast<const _DetectedRobot__ros_msg_type *>(untyped_ros_message);
  // Field name: roi
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DetectedRobot__ros_msg_type * ros_message = static_cast<_DetectedRobot__ros_msg_type *>(untyped_ros_message);
  // Field name: roi
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _DetectedRobot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__msg__DetectedRobot(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__msg__DetectedRobot;
    is_plain =
      (
...
static size_t _DetectedRobot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__msg__DetectedRobot(
...
static message_type_support_callbacks_t __callbacks_DetectedRobot = {
  "robomaster_msgs::msg",
  "DetectedRobot",
