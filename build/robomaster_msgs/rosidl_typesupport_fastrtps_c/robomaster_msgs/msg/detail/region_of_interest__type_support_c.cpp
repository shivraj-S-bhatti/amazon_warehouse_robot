...
#include "robomaster_msgs/msg/detail/region_of_interest__rosidl_typesupport_fastrtps_c.h"
...
using _RegionOfInterest__ros_msg_type = robomaster_msgs__msg__RegionOfInterest;
...
static uint32_t _RegionOfInterest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__msg__RegionOfInterest(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__msg__RegionOfInterest;
    is_plain =
      (
...
static size_t _RegionOfInterest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__msg__RegionOfInterest(
