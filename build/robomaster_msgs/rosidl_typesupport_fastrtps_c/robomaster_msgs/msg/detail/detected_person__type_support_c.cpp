...
#include "robomaster_msgs/msg/detail/detected_person__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedPerson__ros_msg_type = robomaster_msgs__msg__DetectedPerson;
...
static uint32_t _DetectedPerson__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__msg__DetectedPerson(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__msg__DetectedPerson;
    is_plain =
      (
...
static size_t _DetectedPerson__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__msg__DetectedPerson(
