...
#include "robomaster_msgs/msg/detail/camera_config__rosidl_typesupport_fastrtps_c.h"
...
using _CameraConfig__ros_msg_type = robomaster_msgs__msg__CameraConfig;
...
size_t get_serialized_size_robomaster_msgs__msg__CameraConfig(
  const void * untyped_ros_message,
...
static uint32_t _CameraConfig__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomaster_msgs__msg__CameraConfig(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomaster_msgs
size_t max_serialized_size_robomaster_msgs__msg__CameraConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robomaster_msgs__msg__CameraConfig;
    is_plain =
      (
...
static size_t _CameraConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomaster_msgs__msg__CameraConfig(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, msg, CameraConfig)() {
