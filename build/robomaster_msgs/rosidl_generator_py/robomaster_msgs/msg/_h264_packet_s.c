...
bool robomaster_msgs__msg__h264_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomaster_msgs.msg._h264_packet.H264Packet", full_classname_dest, 43) == 0);
  }
  robomaster_msgs__msg__H264Packet * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of H264Packet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomaster_msgs.msg._h264_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "H264Packet");
