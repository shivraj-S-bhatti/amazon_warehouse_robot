...
bool robomaster_msgs__msg__servo_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomaster_msgs.msg._servo_command.ServoCommand", full_classname_dest, 47) == 0);
  }
  robomaster_msgs__msg__ServoCommand * ros_message = _ros_message;
  {  // index
...
PyObject * robomaster_msgs__msg__servo_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomaster_msgs.msg._servo_command");
