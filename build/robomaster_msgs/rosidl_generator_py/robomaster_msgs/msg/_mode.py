...
class Metaclass_Mode(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'GIMBAL_LEAD': cls.__constants['GIMBAL_LEAD'],
            'CHASSIS_LEAD': cls.__constants['CHASSIS_LEAD'],
        }

    @property
    def FREE(self):
        """Message constant 'FREE'."""
        return Metaclass_Mode.__constants['FREE']

    @property
    def GIMBAL_LEAD(self):
        """Message constant 'GIMBAL_LEAD'."""
        return Metaclass_Mode.__constants['GIMBAL_LEAD']

    @property
    def CHASSIS_LEAD(self):
        """Message constant 'CHASSIS_LEAD'."""
        return Metaclass_Mode.__constants['CHASSIS_LEAD']
