...
bool robomaster_msgs__msg__region_of_interest__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomaster_msgs.msg._region_of_interest.RegionOfInterest", full_classname_dest, 56) == 0);
  }
  robomaster_msgs__msg__RegionOfInterest * ros_message = _ros_message;
  {  // x_offset
...
PyObject * robomaster_msgs__msg__region_of_interest__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomaster_msgs.msg._region_of_interest");
