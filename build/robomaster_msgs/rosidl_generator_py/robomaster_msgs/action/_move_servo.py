    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_Goal')
            logger.debug(
...
class Metaclass_MoveServo_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveServo_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveServo_SendGoal_Request(metaclass=Metaclass_MoveServo_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robomaster_msgs/MoveServo_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveServo_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move_servo import MoveServo_Goal
...
class Metaclass_MoveServo_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robomaster_msgs.action import _move_servo
...
class MoveServo_SendGoal(metaclass=Metaclass_MoveServo_SendGoal):
    from robomaster_msgs.action._move_servo import MoveServo_SendGoal_Request as Request
    from robomaster_msgs.action._move_servo import MoveServo_SendGoal_Response as Response
...
class MoveServo_GetResult_Response(metaclass=Metaclass_MoveServo_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robomaster_msgs/MoveServo_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveServo_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robomaster_msgs.action._move_servo import MoveServo_Result
...
class Metaclass_MoveServo_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveServo_GetResult(metaclass=Metaclass_MoveServo_GetResult):
    from robomaster_msgs.action._move_servo import MoveServo_GetResult_Request as Request
    from robomaster_msgs.action._move_servo import MoveServo_GetResult_Response as Response
...
class Metaclass_MoveServo_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveServo_FeedbackMessage(metaclass=Metaclass_MoveServo_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robomaster_msgs/MoveServo_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robomaster_msgs', 'action'], 'MoveServo_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robomaster_msgs.action._move_servo import MoveServo_Feedback
...
class Metaclass_MoveServo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robomaster_msgs.action.MoveServo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveServo(metaclass=Metaclass_MoveServo):
    ...
    from robomaster_msgs.action._move_servo import MoveServo_Goal as Goal
    # The result message defined in the action definition.
    from robomaster_msgs.action._move_servo import MoveServo_Result as Result
    # The feedback message defined in the action definition.
    from robomaster_msgs.action._move_servo import MoveServo_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robomaster_msgs.action._move_servo import MoveServo_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robomaster_msgs.action._move_servo import MoveServo_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robomaster_msgs.action._move_servo import MoveServo_FeedbackMessage as FeedbackMessage
