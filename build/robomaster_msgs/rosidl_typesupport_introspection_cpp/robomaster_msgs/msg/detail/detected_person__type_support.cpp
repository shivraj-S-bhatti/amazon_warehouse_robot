...
{
  new (message_memory) robomaster_msgs::msg::DetectedPerson(_init);
}

void DetectedPerson_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robomaster_msgs::msg::DetectedPerson *>(message_memory);
  typed_message->~DetectedPerson();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedPerson_message_member_array[1] = {
  {
    "roi",  // name
    ...
    offsetof(robomaster_msgs::msg::DetectedPerson, roi),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedPerson_message_members = {
  ...
  1,  // number of fields
  sizeof(robomaster_msgs::msg::DetectedPerson),
...
{
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedPerson_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robomaster_msgs, msg, DetectedPerson)() {
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedPerson_message_type_support_handle;
}
