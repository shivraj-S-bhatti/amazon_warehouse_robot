...
{
  new (message_memory) robomaster_msgs::msg::Mode(_init);
}

void Mode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robomaster_msgs::msg::Mode *>(message_memory);
  typed_message->~Mode();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_message_member_array[1] = {
  {
    ...
    offsetof(robomaster_msgs::msg::Mode, mode),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Mode_message_members = {
  ...
  "Mode",  // message name
  1,  // number of fields
  sizeof(robomaster_msgs::msg::Mode),
...
{
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robomaster_msgs, msg, Mode)() {
  return &::robomaster_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
