...
static const _RegionOfInterest_type_support_symbol_names_t _RegionOfInterest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, msg, RegionOfInterest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robomaster_msgs, msg, RegionOfInterest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robomaster_msgs, msg, RegionOfInterest)() {
  return &::robomaster_msgs::msg::rosidl_typesupport_c::RegionOfInterest_message_type_support_handle;
}
