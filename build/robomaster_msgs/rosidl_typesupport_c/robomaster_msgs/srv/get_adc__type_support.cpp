...
static const _GetADC_Request_type_support_symbol_names_t _GetADC_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetADC_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robomaster_msgs, srv, GetADC_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robomaster_msgs, srv, GetADC_Request)() {
  return &::robomaster_msgs::srv::rosidl_typesupport_c::GetADC_Request_message_type_support_handle;
}
...
static const _GetADC_Response_type_support_symbol_names_t _GetADC_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetADC_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robomaster_msgs, srv, GetADC_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robomaster_msgs, srv, GetADC_Response)() {
  return &::robomaster_msgs::srv::rosidl_typesupport_c::GetADC_Response_message_type_support_handle;
}
...
static const _GetADC_type_support_symbol_names_t _GetADC_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomaster_msgs, srv, GetADC)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robomaster_msgs, srv, GetADC)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robomaster_msgs, srv, GetADC)() {
  return &::robomaster_msgs::srv::rosidl_typesupport_c::GetADC_service_type_support_handle;
}
